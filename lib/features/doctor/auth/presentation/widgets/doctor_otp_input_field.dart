...
class DoctorOtpInputField extends StatefulWidget {
  final bool forceValidation;
  final Color primaryColor;

  const DoctorOtpInputField({
    super.key,
  ...
  @override
  State<DoctorOtpInputField> createState() => _DoctorOtpInputFieldState();
}

class _DoctorOtpInputFieldState extends State<DoctorOtpInputField> {
